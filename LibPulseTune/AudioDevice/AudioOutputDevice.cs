...
namespace LibPulseTune.AudioDevice
{
    public class AudioOutputDevice
    {
        ...
        /// </summary>
        /// <returns></returns>
        public static AudioOutputDevice[] GetAvailableDevices()
        {
        ...
        /// </summary>
        /// <returns></returns>
        public static AudioOutputDevice GetDefaultDevice()
        {
            using (var enumerator = new MMDeviceEnumerator())
            {
        ...
        /// </summary>
        /// <returns></returns>
        internal CustomWasapiOut CreateDeviceInstance()
        {
            if (this.isWasapiDevice)
            {
        ...
        /// <returns></returns>
        public bool IsSameDevice(AudioOutputDevice device)
        {
            if (this.deviceName == device.deviceName &&
                this.isWasapiDevice == device.isWasapiDevice &&
                this.isWasapiEventSync == device.isWasapiEventSync &&
                this.isWasapiExclusiveMode == device.isWasapiExclusiveMode)
            {
                return true;
            }
