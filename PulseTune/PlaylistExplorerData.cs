...
namespace PulseTune
{
    internal static class PlaylistExplorerData
    {
        // 非公開フィールド
        ...
        private static readonly string favoriteLocationsDataPath = $"{Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData)}\\{Program.APPLICATION_NAME}\\favorites.loc";
        private static readonly string recentLocationsDataPath = $"{Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData)}\\{Program.APPLICATION_NAME}\\recent.loc";
